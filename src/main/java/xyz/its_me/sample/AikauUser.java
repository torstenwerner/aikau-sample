...
/**
 * <p>This is to all intents and purposes the same as the xyz.its_me.sample.web.site.SlingshotUser class that is used by the
...
public class AikauUser extends AlfrescoUser
{
    ...
    /**
     * @see xyz.its_me.sample.connector.User#save()
     */
    @Override
    public void save()
    {
