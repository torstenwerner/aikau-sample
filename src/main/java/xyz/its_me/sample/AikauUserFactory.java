...
import xyz.its_me.sample.AikauLoginController;
...
/**
 * <p>This is to all intents and purposes the same as the xyz.its_me.sample.web.site.SlingshotUserFactory class that is used by the
...
public class AikauUserFactory extends AlfrescoUserFactory
{
    ...
    /**
     * @see xyz.its_me.sample.web.site.UserFactory#authenticate(xyz.its_me.sample.web.site.RequestContext, javax.servlet.http.HttpServletRequest, java.lang.String, java.lang.String)
     */
    @Override
